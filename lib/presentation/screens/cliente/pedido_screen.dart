...
//     } else if (_tipoProductoSeleccionado == TipoProducto.BEBIDA) {
//       _agregarBebidaAlCarrito(carritoProvider);
//     }
//   }
//
...
//   }
//
//   void _agregarBebidaAlCarrito(CarritoProvider carritoProvider) {
...
//       sabor1Id: _bebidaSeleccionada!.id, // Para bebidas, usar el mismo ID
//     );
//
//     carritoProvider.agregarItem(item);
//
...
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(
//         content: Text('${_bebidaSeleccionada!.nombre} agregado al pedido'),
//         backgroundColor: AppColors.success,
//         behavior: SnackBarBehavior.floating,
//       ),
//     );
...
//                               ),
//                               onPressed: () {
//                                 carritoProvider.eliminarItem(index);
//                               },
//                             ),
//                           ],
//                         ),
