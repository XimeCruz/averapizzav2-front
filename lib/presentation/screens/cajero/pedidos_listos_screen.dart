...
class _PedidosListosScreenState extends State<PedidosListosScreen> {
  ...
  void _entregar(Pedido pedido) async {
          ...
          Expanded(
            child: Consumer<PedidoProvider>(
              builder: (context, provider, _) {
                ...
                print('=== DEBUG PEDIDOS LISTOS ===');
                print('Status: ${provider.status}');
                print('Total pedidos en provider.pedidos: ${provider.pedidos.length}');
                print('Total pedidos en provider.pedidosListos: ${provider.pedidosListos.length}');

                if (provider.pedidosListos.isNotEmpty) {
                  print('Pedidos listos:');
                  for (var p in provider.pedidosListos) {
                    print('  - Pedido ${p.id}: ${p.estado.name} - Total: ${p.total}');
                  }
                }
                ...
                // Usar pedidosListos en lugar de pedidos
                final pedidos = provider.pedidosListos
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...pedido.detalles.map((detalle) {
                      // Construir descripción de sabores
                      final sabores = [
